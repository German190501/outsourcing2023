            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="ofertas.php" class="nav-link active">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <div class="input-group input-group-sm" style="width: 500px;">
                                            ...
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-default" id="enviar" name="enviar">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../controller/generarPDF.php?id=<?php echo $data['folio']; ?>" class="btn btn-success pdf"><i class="fa-solid fa-file"></i></a>&nbsp;
                                                    </td>
                                                </tr>
